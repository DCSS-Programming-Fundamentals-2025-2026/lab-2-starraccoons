...
namespace CafeRush.Tests
{
    ...
    public class StockAndOrderTests
    {
        ...
        {
            // Arrange - за замовчуванням Milk = 300
        ...
        {
            // Arrange
            _stock.CoffeeBeans = 5; // Espresso потребує 10
            Order order = new Order();
            order.AddDrink(_menuService.Menu[0]); // Espresso
